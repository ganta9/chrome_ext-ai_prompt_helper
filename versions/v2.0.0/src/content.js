...
// 実際に存在するファイルのみを返す（Ver2.0.0修正版）
async function scanPromptFolders() {
  console.log('Ver2.0.0修正版: 既存ファイルのみ読み込み');
    ...
    categories: [
      {
        ...
        subcategories: [
          {
            name: '001_Zero-shot',
            prompts: ['001_基本的なタスク指示.txt', '002_分類タスク.txt']
          },
          {
            name: '002_Few-shot',
